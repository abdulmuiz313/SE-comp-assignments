;Problem Statement: Write x86/64 ALP to perform overlapped block transfer 
;with string specific instructions.Block containing data can be defined in data segment.
;-------------------------.data section------------------------------
section .data
