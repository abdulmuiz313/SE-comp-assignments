;Problem Statement: Write x86/64 ALP to perform non-overlapped block transfer without string specific instructions.Block containing data can be defined in data segment.
;-------------------------.data section------------------------------
section .data
...
;1.Block Transfer without using string instructions
;2.Block Transfer with using string in
;3.Exit